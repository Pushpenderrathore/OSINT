...
2. **Set up tools:**
   Follow the setup and installation instructions located in each tool's directory (`Osintgram`, `blackbird`, `phoneinfoga`, etc.).

3. **Dependencies:**
   For Python scripts, install required libraries using pip:
   ```bash
...
Maintained by [Pushpenderrathore](https://github.com/Pushpenderrathore).
